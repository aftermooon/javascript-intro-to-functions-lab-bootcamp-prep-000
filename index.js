...
function sayHiToGrandma(string) {if (string === "I love you, Grandma.") {return "I love you, too."} else if (string.toLowerCase()) {return "I can't hear you!"} else if (string.toUpperCase()) {return "YES INDEED!"}}
