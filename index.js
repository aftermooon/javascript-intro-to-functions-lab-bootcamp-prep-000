...
function sayHiToGrandma(string) {if (string.toLowerCase) {return "I can't hear you!"} else if (string.toUpperCase) {return "YES INDEED!"} else if (string = "I love you, Grandma.") {return "I love you, too."}}
